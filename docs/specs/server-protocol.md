...
> **⚠ v1 对照文档**：本文是原始 CTF 平台协作协议，已被 `docs/architecture-research-report-pentest-v2.md` §7 + `docs/backend-module-skeleton.md` §2（API 契约）+ `docs/database-ddl-draft.md`（数据）取代。仅作历史与实现参照，**勿作为新平台实现依据**。
