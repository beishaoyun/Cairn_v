...
> **⚠ v1 对照文档**：本文是原始 CTF 平台 Dispatcher 设计，已被 `docs/architecture-research-report-pentest-v2.md` §8 + `docs/backend-module-skeleton.md` + `docs/dispatch-config-spec.md` 取代。仅作历史与实现参照，**勿作为新平台实现依据**。
